package com.armandroid.sdkads.layout;
...
import com.armandroid.armanads.BuildConfig;
import com.armandroid.armanads.R;
import com.armandroid.sdkads.cennections.ConnectionPromote;
import com.armandroid.sdkads.config.AppsConfig;
import com.armandroid.sdkads.interfaces.OnClosed;
    ...
    private void updateInterstitial(int index) {
        ...
        install.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dismiss();
                AppsConfig.openAdLink(activity.getApplicationContext(), "https://=" + data_packageName + "&placement_id=" + APPID);
                if (BuildConfig.DEBUG) {
        ...
        mWebView.clearHistory();
        mWebView.clearCache(true);
        mWebView.loadUrl("https://=" + data_packageName + "&placement_id=" + APPID);
