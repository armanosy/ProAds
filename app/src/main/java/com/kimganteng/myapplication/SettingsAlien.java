...
public class SettingsAlien {
    ...
    public static  String Select_Main_Ads ="none";
    ...
    public static  String Backup_Initialize="161206471383696";
    ...
    Ads for Armandroid
     */
    public static String AppIDMediationAds ="161206471383696";
    public static String AppIDViewAds ="161206471383696";
}
